...
/**
 * Interface representing the mandatory functions of a car on the racetrack.<br/> IMPORTANT: This
 ...
 * {@link ch.zhaw.pm2.racetrack.Car}<br/> Full Javadoc can be found in the implementation file.
 */
